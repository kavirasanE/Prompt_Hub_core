        ...
        <div className="flex w-full flex-col  p-4 md:flex-row">
          <div className="mb-4 md:mb-0 md:mr-4">
            ...
            <p className=" flex items-center text-sm p-2 text-justify font-normal text-gray-500 dark:text-gray-400">
              Your feedback is valuable to us. By sharing your thoughts, you help us understand what
              we're doing well and where we can improve. Whether it's a feature you love, an issue
              you've encountered, or a suggestion for something new, we want to hear from you.
              Please take a moment to provide your insights. Your input directly influences the
              enhancements we make to better serve you. Thank you for helping us create a better
